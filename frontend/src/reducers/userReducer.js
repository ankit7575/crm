...
export const userReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case LOAD_USER_REQUEST:
      // Prevent redundant requests if user is already loaded
      if (state.isUserLoaded) {
        console.log('User data is already loaded. Skipping request.');
        return state; // Don't trigger a new request
      }
      return {
        ...state,
        loading: true,
    ...
    case VERIFY_OTP_SUCCESS:
      return {
        ...
        error: null,
        message: null,
        isUserLoaded: true, // Mark as loaded
      };
    ...
    case LOGOUT_USER:
      return {
        ...state,
        user: null,
        isAuthenticated: false, // Set to false when logging out
        error: null,
        message: null,
        isUserLoaded: false, // Reset isUserLoaded flag
      };
